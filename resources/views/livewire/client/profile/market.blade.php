<div>
    ...
    <div class="market market--v2">
        <div class="container container--market-v2">
            ...
            <nav class="navbar navbar-expand-lg header-navbar header-navbar-dashboard--v2" $wallet>
            ...
            <div class="container container--dashboard">
                ...
                <div class="market-group">
                    <div class="market-group-carousel">
                                ...
                                <div class="standard-card standard-card--type-1">
                                    <div class="container">
                                        ...
                                        <div class="standard-card__content">
                                            <img src="{{@$topGainer['image'] }}" alt=""
                                                 class="standard-card__content-image">
                                            <div class="standard-card__content-desc">
                                                <p class="standard-card__content-desc-price">
                                                    دلار {{number_format($topGainer['current_price'])}}</p>
                                            ...
                                            <div class="standard-card__content-graph">
                                                <div class="standard-card__content-percentage">
                                                    <img class="standard-card__content-arrow"
                                                         src="/client/assets/media/images/icons/green-arrow-up.svg"
                                                         alt="">
                                                    <p class="standard-card__content-value">
                                                        ({{ number_format($topGainer['price_change_percentage_24h'], 2) }}
                                                        %)</p>
                                                </div>
                            ...
                            @if($topLoser)
                                <div class="standard-card standard-card--type-1">
                                    <div class="container">
                                        ...
                                        <div class="standard-card__content">
                                            <img src="{{@$topLoser['image'] }}" alt=""
                                                 class="standard-card__content-image">
                                            <div class="standard-card__content-desc">
                                                <p class="standard-card__content-desc-price">
                                                    دلار {{number_format($topLoser['current_price'])}}</p>
                                                <p class="standard-card__content-desc-currency">{{ $topLoser['name'] }}</p>
                                            </div>
                                            <div class="standard-card__content-graph">
                                                <div class="standard-card__content-percentage">
                                                    <p class="standard-card__content-value" style="color: red">
                                                        ({{ number_format($topLoser['price_change_percentage_24h'], 2) }}
                                                        %)</p>
                                                </div>
                        ...
                        <div class="slick__pagination">
                            <div class="assets-carousel__arrows">
                                <a href="market-v2.html#" class="assets-carousel__prev">
                                    <img src="/client/assets/media/images/icons/light-circle-arrow-left.svg"
                                         alt="Previous">
                                </a>
                                <a href="market-v2.html#" class="assets-carousel__next">
                                    <img src="/client/assets/media/images/icons/light-circle-arrow-right.svg"
                                         alt="Next">
                                </a>
                            </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="pills-market-table-all" role="tabpanel"
                                ...
                                <div class="table-container">
                                    <input type="text" class="form-input" placeholder="جستجو..."
                                    ...
                                    <table class="table table-content">
                                        ...
                                        @foreach($cryptos as $crypto)
                                            ...
                                            <tr>
                                                <td class="table__assets" data-search-input="fade-show">
                                                ...
                                                <td>
                                                    <p class="fb-regular">{{ number_format(@$crypto['current_price']*$usdToToman)}}
                                                        تومان </p>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('client.profile.trade', $crypto['id']) }}"
                                                       class="btn btn-primary btn-sm btn-pill table__btn">خرید </a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
