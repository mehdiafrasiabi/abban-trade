            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        ...
                        <span class="logo-sm">
                            <img  src="/admin/assets/images/logo-sm.png" alt="" height="120">
                        </span>
                            <span class="logo-lg">
                            <img src="/admin/assets/images/logo-dark.png" alt="" height="120">
                        </span>
                        </a>
                        ...
                        <span class="logo-sm">
                            ...
                            <span class="logo-lg">
                            <img src="/admin/assets/images/logo-light.png" alt="" height="120">
                        </span>
                        </a>
                    </div>
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-semibold user-name-text">مهدی افراسیابی(آبان)</span>
                                <span class="d-none d-xl-block ms-1 fs-13 user-name-sub-text">بنیانگذار</span>
                            </span>
                        </span>
                        </button>
